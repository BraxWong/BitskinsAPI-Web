...
function directToLoginPage() {
  alert(
    "This email has already been registered, directing you to the login page",
  );
...
function sign_up() {
  //Make sure the site is not getting spammed
  var troll = document.getElementById("troll-defender").value;
  if (troll === "") {
